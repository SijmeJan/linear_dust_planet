...
from surface_density import calc_surface_density_along_streamlines

def calculate_accretion_efficiency(moc, param_dict, from_streamlines=False):
    if from_streamlines is True:
        ...
        return len(np.asarray(np.abs(r_final-1)<0.05).nonzero()[0])/N
